/*
 * usage.c -> show usage of pcf8574_lcd160x driver
 *
 * GPL
...
main(int argc, char *argv[])
{
	...
	int c;
	while ((c = getopt(argc, argv, "p:b:a:h")) != -1) {
		switch (c) {
		case 'p':
